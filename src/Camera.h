...
public:
  ...
  glm::mat4 GetProjectionMatrix(size_t windowWidth, size_t windowHeight) const
  {
    return glm::perspective(glm::radians(Zoom), (float)windowWidth / (float)windowHeight, 0.1f, 100.0f);
  }

  // processes input received from any keyboard-like input system. Accepts input parameter in the form of camera defined ENUM (to abstract it from windowing systems)
  void ProcessKeyboard(Camera_Movement direction, float deltaTime, bool accelerationEnabled)
  {
